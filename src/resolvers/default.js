...
exports.resolveTheme = (palette, { getColorByAppearance }) => {
    ...
    theme.editorActiveLineBackground = getColorByAppearance({
    ...
    theme.indentGuideActive = blend(theme.transparent, theme.foreground, 0.52);
    ...
    theme.terminalAnsiBrightBlack = getColorByAppearance({
    ...
    theme.terminalAnsiBrightWhite = getColorByAppearance({
        dark: lighten(theme.foreground, 0.2),
        light: lighten(theme.background, 0.2),
    });

    theme.terminalAnsiDimBlack = getColorByAppearance({
